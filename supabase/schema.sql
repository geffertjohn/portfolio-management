...
CREATE TABLE IF NOT EXISTS "public"."import_runs" (
    ...
    CONSTRAINT "import_runs_source_check" CHECK (("source" = ANY (ARRAY['ycharts_benchmarks'::"text", 'ycharts_funds'::"text", 'ycharts_security'::"text", 'ycharts_security_metrics'::"text", 'ycharts_portfolios'::"text", 'ycharts_allocations'::"text"])))
);
...
ALTER TABLE "public"."import_runs" ALTER COLUMN "id" ADD GENERATED ALWAYS AS IDENTITY (
...
CREATE POLICY "import_runs are readable by anon" ON "public"."import_runs" FOR SELECT TO "authenticated", "anon" USING (true);



CREATE POLICY "import_runs are writable by anon" ON "public"."import_runs" FOR INSERT TO "authenticated", "anon" WITH CHECK (true);
...
GRANT ALL ON SEQUENCE "public"."import_runs_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."import_runs_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."import_runs_id_seq" TO "service_role";
